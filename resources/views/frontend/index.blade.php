...
<head>
    ...
    <!-- font-awesome css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_assets') }}/css/vendors/font-awesome.css">

    <!-- feather icon css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_assets') }}/css/vendors/feather-icon.css">

    <!-- slick css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_assets') }}/css/vendors/slick/slick.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_assets') }}/css/vendors/slick/slick-theme.css">

    <!-- Iconly css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_assets') }}/css/bulk-style.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend_assets') }}/css/vendors/animate.css">

    <!-- Template css -->
    <link id="color-link" rel="stylesheet" type="text/css" href="{{ asset('frontend_assets') }}/css/style.css">
</head>
...
<body class="bg-effect">
                ...
                <div class="col-12">
                    <div class="header-nav">
                        <div class="header-nav-left">
                            ...
                            {{--  {{ $all_categories }}  user form frontend controller --}}
                                    ...
                                    @foreach ($all_categories as $category)
                                        <li class="onhover-category-list">
                                            <a href="shop-top-filter.html" class="category-name">
                                                <img src="{{ asset('uploads/category_photos') }}/{{ $category->category_image }}"
                                                    alt="">
                    ...
                    <div class="row g-4">
                        <div class="col-xl-12 col-md-6">
                            <div class="home-contain">
                                <img src="{{ asset('frontend_assets') }}/images/vegetable/banner/2.jpg"
                                    class="bg-img blur-up lazyload" alt="">
                        ...
                        <div class="col-xl-12 col-md-6">
                            <div class="home-contain">
                                <img src="{{ asset('frontend_assets') }}/images/vegetable/banner/3.jpg"
                                    class="bg-img blur-up lazyload" alt="">
                                <div class="home-detail p-center-left home-p-sm w-75">
                                    <div>
            ...
            <div class="banner-slider">
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="{{ asset('frontend_assets') }}/images/vegetable/banner/4.jpg"
                            class="bg-img blur-up lazyload" alt="">
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="{{ asset('frontend_assets') }}/images/vegetable/banner/5.jpg"
                            class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="{{ asset('frontend_assets') }}/images/vegetable/banner/6.jpg"
                            class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="{{ asset('frontend_assets') }}/images/vegetable/banner/7.jpg"
                            class="bg-img blur-up lazyload" alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
            ...
            <div class="row g-sm-4 g-3">
                <div class="col-xxl-3 col-xl-4 d-none d-xl-block">
                    <div class="p-sticky">
                        <div class="category-menu">
                            <h3>Category</h3>
                            <ul>
                                @foreach ($all_categories as $category_menu)
                                    <li>
                                        <div class="category-list">
                                            <img src="{{ asset('uploads/category_photos') }}/{{ $category_menu->category_image }}"
                                                alt="">
                                            {{--     <img src="{{ asset('frontend_assets') }}/svg/1/vegetable.svg"
                                                class="blur-up lazyload" alt=""> --}}
                                            {{--    <img src="{{ asset('frontend_assets') }}/svg/1/vegetable.svg"
                                            ...
                                            <h5>
                                                <a
                                                    href="shop-left-sidebar.html">{{ $category_menu->category_name }}</a>
                                            </h5>
                                        </div>
                                    </li>
                                @endforeach
                        ...
                        <div class="ratio_medium section-t-space">
                            <div class="home-contain hover-effect">
                                <img src="{{ asset('frontend_assets') }}/images/vegetable/banner/11.jpg"
                                    class="img-fluid blur-up lazyload" alt="">
                                <div class="home-detail p-top-left home-p-medium">
                                    <div>
                                ...
                                <div class="review-box">
                                    ...
                                    <div class="review-profile">
                                        <div class="review-image">
                                            <img src="{{ asset('frontend_assets') }}/images/vegetable/review/1.jpg"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </div>
                ...
                <div class="col-xxl-9 col-xl-8">
                                            ...
                                            <div class="col-sm-12 col-md-3 col-lg-4">
                                                ...
                                                <div class="product-box">
                                                    ...
                                                    <div class="product-image">
                                                        <a href="product-left-thumbnail.html">
                                                            <img src="{{ asset('uploads/products_photos') }}/{{ $product->product_thumbnail }}"
                                                                class="img-fluid  " alt="">
                                                        </a>
                                                    ...
                                                    <div class="product-detail">
                                                        ...
                                                        <h5 class="sold text-content">
                                                            ...
                                                            <del>${{ $product->regular_product_price }}</del>
                                                        </h5>
                                    ...
                                    <div class="row m-0">
                                        ...
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('frontend_assets') }}/images/vegetable/product/8.png"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <div class="row m-0">
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('frontend_assets') }}/images/vegetable/product/9.png"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                                        ...
                                        <div class="col-12 px-0">
                                            <div class="product-box">
                                                <div class="product-image">
                                                    <a href="product-left-thumbnail.html">
                                                        <img src="{{ asset('frontend_assets') }}/images/vegetable/product/10.png"
                                                            class="img-fluid blur-up lazyload" alt="">
                                                    </a>
                                                    <ul class="product-option">
                                                        <li data-bs-toggle="tooltip" data-bs-placement="top"
                    ...
                    <div class="category-slider-2 product-wrapper no-arrow">
                        @foreach ($all_categories as $category_slider)
                            <div>
                                <a href="shop-left-sidebar.html" class="category-box category-dark">
                                    <div>
                                        <img src="{{ asset('uploads/category_photos') }}/{{ $category_slider->category_image }}"
                                            class="blur-up lazyload" alt="">
                                        {{--      <img src="{{ asset('frontend_assets') }}/svg/1/vegetable.svg"
                                            class="blur-up lazyload" alt=""> --}}
                                        <h5>{{ $category_slider->category_name }}</h5>
                                    </div>
                                </a>
                            </div>
                        @endforeach
                    ...
                    <div class="slider-3-blog ratio_65 no-arrow product-wrapper">
                            ...
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="{{ asset('frontend_assets') }}/images/vegetable/blog/1.jpg"
                                            class="bg-img blur-up lazyload" alt="">
                                    </a>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="{{ asset('frontend_assets') }}/images/vegetable/blog/2.jpg"
                                            class="bg-img blur-up lazyload" alt="">
                                    </a>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="{{ asset('frontend_assets') }}/images/vegetable/blog/3.jpg"
                                            class="bg-img blur-up lazyload" alt="">
                                    </a>
                                </div>
                ...
                <div class="row g-3">
                    <div class="col-12">
                        <div class="service-contain">
                            ...
                            <div class="service-box">
                                <div class="service-image">
                                    <img src="{{ asset('frontend_assets') }}/svg/market.svg"
                                        class="blur-up lazyload" alt="">
                                </div>
                    ...
                    <div class="row g-sm-4 g-2">
                        <div class="col-lg-6">
                            <div class="slider-image">
                                <img src="{{ asset('frontend_assets') }}/images/product/category/1.jpg"
                                    class="img-fluid blur-up lazyload" alt="">
                            </div>
                        </div>
    ...
    <!-- Timer Js -->
    <script src="{{ asset('frontend_assets') }}/js/timer1.js"></script>

    <!-- Fly Cart Js -->
    <script src="{{ asset('frontend_assets') }}/js/fly-cart.js"></script>

    <!-- Quantity js -->
    <script src="{{ asset('frontend_assets') }}/js/quantity-2.js"></script>

    <!-- WOW js -->
    <script src="{{ asset('frontend_assets') }}/js/wow.min.js"></script>
    <script src="{{ asset('frontend_assets') }}/js/custom-wow.js"></script>
