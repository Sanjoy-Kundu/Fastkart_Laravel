                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="theme-form theme-form-2 mega-form" method="POST"
                                        enctype="multipart/form-data" action={{ url('category/insert') }}>
                                        @csrf
                                        ...
                                        <div class="mb-4 row align-items-center">
                                            ...
                                            <label for="category_description"
                                                class="form-label-title col-sm-3 mb-0">Category Description</label>
                                            <div class="col-sm-9">
                                                <textarea id="category_description" rows="5" cols='40' name="category_description"></textarea>
